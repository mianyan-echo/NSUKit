...
class I_BaseCmdUItf: public U_Interface {
 ...
 * 通道类
 */
class I_BaseChnlUItf: public U_Interface {
public:
    ...
    virtual nsukitStatus_t send_open(nsuChnlNum_t chnl, nsuMemory_p fd, nsuStreamLen_t length, nsuStreamLen_t offset=0) {
        return nsukitStatus_t::NSUKIT_STATUS_NEED_RELOAD;
    }

    virtual nsukitStatus_t recv_open(nsuChnlNum_t chnl, nsuMemory_p fd, nsuStreamLen_t length, nsuStreamLen_t offset=0) {
        return nsukitStatus_t::NSUKIT_STATUS_NEED_RELOAD;
    }
    ...
    virtual nsukitStatus_t stream_read(nsuChnlNum_t chnl, nsuMemory_p fd, nsuStreamLen_t length, nsuStreamLen_t offset=0,
